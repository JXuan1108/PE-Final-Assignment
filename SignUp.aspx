                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-top: 20px">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <%--<asp:RequiredFieldValidator runat="server" ID="PasswordFieldValidator" ControlToValidate="password" ErrorMessage="Please enter your password.<br />" forecolor="Red" Display="Dynamic" style="margin-left: 5px"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="PasswordRegularExpressionValidator" Display="Dynamic" errormessage="Password must be 8-10 characters long</br> with at least one numeric character." forecolor="Red" ValidationExpression="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{8,10})$" ControlToValidate="password" runat="server" style="margin-left: 5px"></asp:RegularExpressionValidator>--%>
                                </div>
                            </div>
                        </div>
                        <div class="row" style="margin-top: 20px">
                        ...
                        <div class="row" style="margin-top: 20px">
                            <div class="form-group d-grid gap-2">
                                <asp:Button class="btn btn-primary" ID="signUp" runat="server" Text="Sign Up" OnClick="signUp_Click" />
                            </div>
                        </div>
